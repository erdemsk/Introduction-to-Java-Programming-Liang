...
6. Programming Exercises 6.24, 264
Inspired from the http://soultionmanual.blogspot.com/2016/08/chapter-6-exercise-24-introduction-to.html
...
public class DisplayCurrentDateAndTime {
    public static void main(String[] args) {
        ...
        // Display the result
        System.out.printf("Current date and time is %s %02d:%02d:%02d GMT", getDate(totalHours), currentHour, currentMinute, currentSecond);
    }

    public static String getDate(long numberOfHours) {
        // Compute the total number of days since 1/1/1970
        ...
        while (numberOfDays > 0) {
            ...
            numberOfDays = numberOfDays - dayReduction;
            startYear++;
        }
